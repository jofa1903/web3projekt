...
class Webpages
{
    ...
    {
        $query = "SELECT * FROM  yofal_webb3projekt.webpages";
    ...
    {
        $query = "SELECT * FROM yofal_webb3projekt.webpages WHERE web_id = ?";
    ...
    {
        $query = "INSERT INTO yofal_webb3projekt.webpages 
        SET
            web_title = :web_title,
            url = :url,
...
{
    $query = "UPDATE yofal_webb3projekt.webpages 
    SET
    web_title = :web_title,
    url = :url,
    description = :description
    ...
    public function delete()
    {
        if (isset($_GET['web_id'])) {
            ...
            $query = "DELETE FROM yofal_webb3projekt.webpages WHERE web_id = $web_id";
            $stmt = $this->conn->prepare($query);
