...
class Courses
{
    ...
    {
        $query = "SELECT * FROM  yofal_webb3projekt.courses";
    ...
    {
        $query = "SELECT * FROM yofal_webb3projekt.courses WHERE id = ?";
    ...
    {
        $query = "INSERT INTO yofal_webb3projekt.courses 
        SET
            code = :code,
            name = :name,
...
{
    $query = "UPDATE yofal_webb3projekt.courses 
    SET
        code = :code,
        name = :name,
        progression = :progression,
    ...
    public function delete()
    {
        if (isset($_GET['id'])) {
            ...
            $query = "DELETE FROM yofal_webb3projekt.courses WHERE id = $id";
            $stmt = $this->conn->prepare($query);
